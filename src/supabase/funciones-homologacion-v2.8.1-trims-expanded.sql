-- ============================================================================
-- SISTEMA DE HOMOLOGACIÓN DE VEHÍCULOS - VERSIÓN v2.8.1 - TRIMS EXPANDED
-- ============================================================================
-- CAMBIOS en v2.8.1:
-- - Expandida lista de distinctive_trims de 16 a 78 trims
-- - Resuelve problema de matching incorrecto entre trims diferentes
-- - Caso específico: Honda HR-V PRIME vs TOURING vs SPORT vs UNIQ
-- ============================================================================
...
-- ============================================================================
-- FUNCIÓN 1: normalize_token (SIN CAMBIOS)
-- ============================================================================
...
-- ============================================================================
-- FUNCIÓN 3: clean_and_tokenize_version (SIN CAMBIOS)
-- ============================================================================
...
-- ============================================================================
-- FUNCIÓN 4: is_minimal_version_match (SIN CAMBIOS)
-- ============================================================================
...
-- ============================================================================
-- FUNCIÓN 5: detect_conflicts (SIN CAMBIOS)
-- ============================================================================
...
-- ============================================================================
-- FUNCIÓN 6: has_different_trims - ⭐ EXPANDIDA EN v2.8.1
-- ============================================================================
...
DECLARE
    distinctive_trims TEXT[] := ARRAY[
        -- ⭐ v2.8.1: Lista expandida de 16 → 78 trims

        -- Trims Honda/Acura (caso reportado: HR-V PRIME vs TOURING vs SPORT vs UNIQ)
        'PRIME', 'UNIQ', 'UNIQUE', 'TOURING', 'ELITE', 'EX', 'EXL', 'LX',

        -- Trims genéricos comunes
        'BASE', 'BASICA', 'PREMIUM', 'EXCLUSIVE', 'EXECUTIVE',
        ...
        -- Trims Porsche
        'CARRERA', 'TURBO', 'TARGA', 'BOXSTER', 'CAYMAN',
        ...
        -- Otros trims comunes
        'TECH', 'COMFORT', 'PRESTIGE', 'AMBIENTE', 'TRENDY',
        'REFERENCE', 'CUSTOM', 'SPECIAL-EDITION', 'LUXURY'
    ];
    trim_a TEXT;
    trim_b TEXT;
BEGIN
...
-- ============================================================================
-- FUNCIÓN 7: calculate_weighted_coverage_with_trim_penalty (SIN CAMBIOS)
-- ============================================================================
...
BEGIN
    ...
    -- Pesos optimizados v2.7.8 (mantenidos en v2.8.1)
    FOREACH token IN ARRAY tokens_a LOOP
        token_weight := CASE
...
-- ============================================================================
-- FUNCIÓN 8: calculate_jaccard_similarity (SIN CAMBIOS)
-- ============================================================================
...
-- ============================================================================
-- FUNCIÓN PRINCIPAL: procesar_batch_vehiculos v2.8.1
-- ============================================================================
...
-- ============================================================================
-- FIN - VERSIÓN v2.8.1 - TRIMS EXPANDED
-- ============================================================================
